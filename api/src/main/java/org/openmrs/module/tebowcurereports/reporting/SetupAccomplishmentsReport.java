...
public class SetupAccomplishmentsReport {
	...
	private ReportDefinition createReportDefinition() {
		...
		Parameter form = new Parameter("doctor", "Doctor", User.class);
	...
	private void createDataSetDefinition(ReportDefinition reportDefinition) {
		...
		MappedParametersEncounterQuery q = new MappedParametersEncounterQuery(rowFilter, ObjectUtil.toMap("onOrAfter=startDate,onOrBefore=endDate,encounterTypes=encounterTypes,doctor=doctor"));
